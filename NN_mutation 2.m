...
if (Population{1,i}.r1 == 2 )
    %mutating the spread value
    Population{1,i}.RBF1.b{2,1} = Population{1,i}.RBF1.b{2,1}*prob
    inputweights=Population{1,1}.RBF1.b;
   Population{1,1}.RBF1.b(1,1) = Population{1,1}.RBF1.b{1,1}(1,1)*prob;
   spread = max(1,(0.8326/Population{1,i}.RBF1.b{1,1})*prob);
   Population{1,i}.RBF1.b{2,1} =  Population{1,i}.RBF1.b{1,1}/spread;
   %mutating the centers
